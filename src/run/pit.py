...
class Pit:
    ...
    def battle(self, do_pre_buff: bool) -> Union[bool, tuple[Location, bool]]:
        ...
        if not self._pather.traverse("Monastery Gate", self._char, dest_distance=10): return False
        ...
        if not self._pather.traverse("Pit Level 1", self._char, verify_location=True, dest_distance=10): return False
        if not self._pather.go_to_area("Pit Level 1", "PitLevel1", entrance_in_wall=False, randomize=5): return False
