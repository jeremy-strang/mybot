...
class Pindle:
    ...
    def approach(self, start_loc: Location) -> Union[bool, Location]:
        ...
        #    return False
        #self._pather_v2.traverse([122,122], self._char,verify_location=True)
        if not self._pather_v2.traverse_walking([122,122],self._char, obj=False,threshold=10,static_npc=False,end_dist=5): return False
        wait(0.5, 0.6)
    ...
    def battle(self, do_pre_buff: bool) -> Union[bool, tuple[Location, bool]]:
        ...
        if self._char.capabilities.can_teleport_natively and self._config.char['type'] != 'necro':
            ...
            self._pather_v2.traverse([62,90], self._char,verify_location=True)
