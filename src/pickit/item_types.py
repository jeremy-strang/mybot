...
class Action(Enum):
    ...
    def _missing_(value):
        if type(value) is int:
            ...
            return Action.Keep if value else Action.DontKeep
...
class Stat:
    ...
    # The following are used for skillers
    AmazonBowAndCrossbow = "AmazonBowAndCrossbow"
    AmazonPassiveAndMagic = "AmazonPassiveAndMagic"
    AmazonJavelinAndSpear = "AmazonJavelinAndSpear"
    SorceressFire = "SorceressFire"
    SorceressLightning = "SorceressLightning"
    SorceressCold = "SorceressCold"
    NecromancerCurses = "NecromancerCurses"
    NecromancerPoisonAndBone = "NecromancerPoisonAndBone"
    NecromancerSummoning = "NecromancerSummoning"
    ...
    DruidSummoning = "DruidSummoning"
    DruidShapeShifting = "DruidShapeShifting"
    DruidElemental = "DruidElemental"
    AssassinTraps = "AssassinTraps"
    AssassinShadowDisciplines = "AssassinShadowDisciplines"
    AssassinMartialArts = "AssassinMartialArts"
    # ED stat in jewels
    EnhancedDamageMax = "EnhancedDamageMax"
    ...
    Paladin = "Paladin"
    Sorceress = "Sorceress"
    # Note, some of the below stats don't exist, but if a skill can be charged, it will be in here
    UnsetCharges = "UnsetCharges"
    AttackCharges = "AttackCharges"
    KickCharges = "KickCharges"
    ThrowCharges = "ThrowCharges"
    UnsummonCharges = "UnsummonCharges"
    LeftHandThrowCharges = "LeftHandThrowCharges"
    LeftHandSwingCharges = "LeftHandSwingCharges"
    MagicArrowCharges = "MagicArrowCharges"
    FireArrowCharges = "FireArrowCharges"
    InnerSightCharges = "InnerSightCharges"
    CriticalStrikeCharges = "CriticalStrikeCharges"
    JabCharges = "JabCharges"
    ColdArrowCharges = "ColdArrowCharges"
    MultipleShotCharges = "MultipleShotCharges"
    DodgeCharges = "DodgeCharges"
    PowerStrikeCharges = "PowerStrikeCharges"
    PoisonJavelinCharges = "PoisonJavelinCharges"
    ExplodingArrowCharges = "ExplodingArrowCharges"
    SlowMissilesCharges = "SlowMissilesCharges"
    AvoidCharges = "AvoidCharges"
    ImpaleCharges = "ImpaleCharges"
    LightningBoltCharges = "LightningBoltCharges"
    IceArrowCharges = "IceArrowCharges"
    GuidedArrowCharges = "GuidedArrowCharges"
    PenetrateCharges = "PenetrateCharges"
    ChargedStrikeCharges = "ChargedStrikeCharges"
    PlagueJavelinCharges = "PlagueJavelinCharges"
    StrafeCharges = "StrafeCharges"
    ImmolationArrowCharges = "ImmolationArrowCharges"
    DecoyCharges = "DecoyCharges"
    EvadeCharges = "EvadeCharges"
    FendCharges = "FendCharges"
    FreezingArrowCharges = "FreezingArrowCharges"
    ValkyrieCharges = "ValkyrieCharges"
    PierceCharges = "PierceCharges"
    LightningStrikeCharges = "LightningStrikeCharges"
    LightningFuryCharges = "LightningFuryCharges"
    FireBoltCharges = "FireBoltCharges"
    WarmthCharges = "WarmthCharges"
    ChargedBoltCharges = "ChargedBoltCharges"
    IceBoltCharges = "IceBoltCharges"
    FrozenArmorCharges = "FrozenArmorCharges"
    InfernoCharges = "InfernoCharges"
    StaticFieldCharges = "StaticFieldCharges"
    TelekinesisCharges = "TelekinesisCharges"
    FrostNovaCharges = "FrostNovaCharges"
    IceBlastCharges = "IceBlastCharges"
    BlazeCharges = "BlazeCharges"
    FireBallCharges = "FireBallCharges"
    NovaCharges = "NovaCharges"
    LightningCharges = "LightningCharges"
    ShiverArmorCharges = "ShiverArmorCharges"
    FireWallCharges = "FireWallCharges"
    EnchantCharges = "EnchantCharges"
    ChainLightningCharges = "ChainLightningCharges"
    TeleportCharges = "TeleportCharges"
    GlacialSpikeCharges = "GlacialSpikeCharges"
    MeteorCharges = "MeteorCharges"
    ThunderStormCharges = "ThunderStormCharges"
    EnergyShieldCharges = "EnergyShieldCharges"
    BlizzardCharges = "BlizzardCharges"
    ChillingArmorCharges = "ChillingArmorCharges"
    FireMasteryCharges = "FireMasteryCharges"
    HydraCharges = "HydraCharges"
    LightningMasteryCharges = "LightningMasteryCharges"
    FrozenOrbCharges = "FrozenOrbCharges"
    ColdMasteryCharges = "ColdMasteryCharges"
    AmplifyDamageCharges = "AmplifyDamageCharges"
    TeethCharges = "TeethCharges"
    BoneArmorCharges = "BoneArmorCharges"
    SkeletonMasteryCharges = "SkeletonMasteryCharges"
    RaiseSkeletonCharges = "RaiseSkeletonCharges"
    DimVisionCharges = "DimVisionCharges"
    WeakenCharges = "WeakenCharges"
    PoisonDaggerCharges = "PoisonDaggerCharges"
    CorpseExplosionCharges = "CorpseExplosionCharges"
    ClayGolemCharges = "ClayGolemCharges"
    IronMaidenCharges = "IronMaidenCharges"
    TerrorCharges = "TerrorCharges"
    BoneWallCharges = "BoneWallCharges"
    GolemMasteryCharges = "GolemMasteryCharges"
    RaiseSkeletalMageCharges = "RaiseSkeletalMageCharges"
    ConfuseCharges = "ConfuseCharges"
    LifeTapCharges = "LifeTapCharges"
    PoisonExplosionCharges = "PoisonExplosionCharges"
    BoneSpearCharges = "BoneSpearCharges"
    BloodGolemCharges = "BloodGolemCharges"
    AttractCharges = "AttractCharges"
    DecrepifyCharges = "DecrepifyCharges"
    BonePrisonCharges = "BonePrisonCharges"
    SummonResistCharges = "SummonResistCharges"
    IronGolemCharges = "IronGolemCharges"
    LowerResistCharges = "LowerResistCharges"
    PoisonNovaCharges = "PoisonNovaCharges"
    BoneSpiritCharges = "BoneSpiritCharges"
    FireGolemCharges = "FireGolemCharges"
    ReviveCharges = "ReviveCharges"
    SacrificeCharges = "SacrificeCharges"
    SmiteCharges = "SmiteCharges"
    MightCharges = "MightCharges"
    PrayerCharges = "PrayerCharges"
    ResistFireCharges = "ResistFireCharges"
    HolyBoltCharges = "HolyBoltCharges"
    HolyFireCharges = "HolyFireCharges"
    ThornsCharges = "ThornsCharges"
    DefianceCharges = "DefianceCharges"
    ResistColdCharges = "ResistColdCharges"
    ZealCharges = "ZealCharges"
    ChargeCharges = "ChargeCharges"
    BlessedAimCharges = "BlessedAimCharges"
    CleansingCharges = "CleansingCharges"
    ResistLightningCharges = "ResistLightningCharges"
    VengeanceCharges = "VengeanceCharges"
    BlessedHammerCharges = "BlessedHammerCharges"
    ConcentrationCharges = "ConcentrationCharges"
    HolyFreezeCharges = "HolyFreezeCharges"
    VigorCharges = "VigorCharges"
    ConversionCharges = "ConversionCharges"
    HolyShieldCharges = "HolyShieldCharges"
    HolyShockCharges = "HolyShockCharges"
    SanctuaryCharges = "SanctuaryCharges"
    MeditationCharges = "MeditationCharges"
    FistOfTheHeavensCharges = "FistOfTheHeavensCharges"
    FanaticismCharges = "FanaticismCharges"
    ConvictionCharges = "ConvictionCharges"
    RedemptionCharges = "RedemptionCharges"
    SalvationCharges = "SalvationCharges"
    BashCharges = "BashCharges"
    SwordMasteryCharges = "SwordMasteryCharges"
    AxeMasteryCharges = "AxeMasteryCharges"
    MaceMasteryCharges = "MaceMasteryCharges"
    HowlCharges = "HowlCharges"
    FindPotionCharges = "FindPotionCharges"
    LeapCharges = "LeapCharges"
    DoubleSwingCharges = "DoubleSwingCharges"
    PolearmMasteryCharges = "PolearmMasteryCharges"
    ThrowingMasteryCharges = "ThrowingMasteryCharges"
    SpearMasteryCharges = "SpearMasteryCharges"
    TauntCharges = "TauntCharges"
    ShoutCharges = "ShoutCharges"
    StunCharges = "StunCharges"
    DoubleThrowCharges = "DoubleThrowCharges"
    IncreasedStaminaCharges = "IncreasedStaminaCharges"
    FindItemCharges = "FindItemCharges"
    LeapAttackCharges = "LeapAttackCharges"
    ConcentrateCharges = "ConcentrateCharges"
    IronSkinCharges = "IronSkinCharges"
    BattleCryCharges = "BattleCryCharges"
    FrenzyCharges = "FrenzyCharges"
    IncreasedSpeedCharges = "IncreasedSpeedCharges"
    BattleOrdersCharges = "BattleOrdersCharges"
    GrimWardCharges = "GrimWardCharges"
    WhirlwindCharges = "WhirlwindCharges"
    BerserkCharges = "BerserkCharges"
    NaturalResistanceCharges = "NaturalResistanceCharges"
    WarCryCharges = "WarCryCharges"
    BattleCommandCharges = "BattleCommandCharges"
    FireHitCharges = "FireHitCharges"
    UnHolyBoltCharges = "UnHolyBoltCharges"
    SkeletonRaiseCharges = "SkeletonRaiseCharges"
    MaggotEggCharges = "MaggotEggCharges"
    ShamanFireCharges = "ShamanFireCharges"
    MagottUpCharges = "MagottUpCharges"
    MagottDownCharges = "MagottDownCharges"
    MagottLayCharges = "MagottLayCharges"
    AndrialSprayCharges = "AndrialSprayCharges"
    JumpCharges = "JumpCharges"
    SwarmMoveCharges = "SwarmMoveCharges"
    NestCharges = "NestCharges"
    QuickStrikeCharges = "QuickStrikeCharges"
    VampireFireballCharges = "VampireFireballCharges"
    VampireFirewallCharges = "VampireFirewallCharges"
    VampireMeteorCharges = "VampireMeteorCharges"
    GargoyleTrapCharges = "GargoyleTrapCharges"
    SpiderLayCharges = "SpiderLayCharges"
    VampireHealCharges = "VampireHealCharges"
    VampireRaiseCharges = "VampireRaiseCharges"
    SubmergeCharges = "SubmergeCharges"
    FetishAuraCharges = "FetishAuraCharges"
    FetishInfernoCharges = "FetishInfernoCharges"
    ZakarumHealCharges = "ZakarumHealCharges"
    EmergeCharges = "EmergeCharges"
    ResurrectCharges = "ResurrectCharges"
    BestowCharges = "BestowCharges"
    MissileSkill1Charges = "MissileSkill1Charges"
    MonTeleportCharges = "MonTeleportCharges"
    PrimeLightningCharges = "PrimeLightningCharges"
    PrimeBoltCharges = "PrimeBoltCharges"
    PrimeBlazeCharges = "PrimeBlazeCharges"
    PrimeFirewallCharges = "PrimeFirewallCharges"
    PrimeSpikeCharges = "PrimeSpikeCharges"
    PrimeIceNovaCharges = "PrimeIceNovaCharges"
    PrimePoisonballCharges = "PrimePoisonballCharges"
    PrimePoisonNovaCharges = "PrimePoisonNovaCharges"
    DiabLightCharges = "DiabLightCharges"
    DiabColdCharges = "DiabColdCharges"
    DiabFireCharges = "DiabFireCharges"
    FingerMageSpiderCharges = "FingerMageSpiderCharges"
    DiabWallCharges = "DiabWallCharges"
    DiabRunCharges = "DiabRunCharges"
    DiabPrisonCharges = "DiabPrisonCharges"
    PoisonBallTrapCharges = "PoisonBallTrapCharges"
    AndyPoisonBoltCharges = "AndyPoisonBoltCharges"
    HireableMissileCharges = "HireableMissileCharges"
    DesertTurretCharges = "DesertTurretCharges"
    ArcaneTowerCharges = "ArcaneTowerCharges"
    MonBlizzardCharges = "MonBlizzardCharges"
    MosquitoCharges = "MosquitoCharges"
    CursedBallTrapRightCharges = "CursedBallTrapRightCharges"
    CursedBallTrapLeftCharges = "CursedBallTrapLeftCharges"
    MonFrozenArmorCharges = "MonFrozenArmorCharges"
    MonBoneArmorCharges = "MonBoneArmorCharges"
    MonBoneSpiritCharges = "MonBoneSpiritCharges"
    MonCurseCastCharges = "MonCurseCastCharges"
    HellMeteorCharges = "HellMeteorCharges"
    RegurgitatorEatCharges = "RegurgitatorEatCharges"
    MonFrenzyCharges = "MonFrenzyCharges"
    QueenDeathCharges = "QueenDeathCharges"
    ScrollOfIdentifyCharges = "ScrollOfIdentifyCharges"
    TomeOfIdentifyCharges = "TomeOfIdentifyCharges"
    ScrollOfTownPortalCharges = "ScrollOfTownPortalCharges"
    TomeOfTownPortalCharges = "TomeOfTownPortalCharges"
    RavenCharges = "RavenCharges"
    PoisonCreeperCharges = "PoisonCreeperCharges"
    WerewolfCharges = "WerewolfCharges"
    LycanthropyCharges = "LycanthropyCharges"
    FirestormCharges = "FirestormCharges"
    OakSageCharges = "OakSageCharges"
    SummonSpiritWolfCharges = "SummonSpiritWolfCharges"
    WerebearCharges = "WerebearCharges"
    MoltenBoulderCharges = "MoltenBoulderCharges"
    ArcticBlastCharges = "ArcticBlastCharges"
    CarrionVineCharges = "CarrionVineCharges"
    FeralRageCharges = "FeralRageCharges"
    MaulCharges = "MaulCharges"
    FissureCharges = "FissureCharges"
    CycloneArmorCharges = "CycloneArmorCharges"
    HeartOfWolverineCharges = "HeartOfWolverineCharges"
    SummonDireWolfCharges = "SummonDireWolfCharges"
    RabiesCharges = "RabiesCharges"
    FireClawsCharges = "FireClawsCharges"
    TwisterCharges = "TwisterCharges"
    SolarCreeperCharges = "SolarCreeperCharges"
    HungerCharges = "HungerCharges"
    ShockWaveCharges = "ShockWaveCharges"
    VolcanoCharges = "VolcanoCharges"
    TornadoCharges = "TornadoCharges"
    SpiritOfBarbsCharges = "SpiritOfBarbsCharges"
    SummonGrizzlyCharges = "SummonGrizzlyCharges"
    FuryCharges = "FuryCharges"
    ArmageddonCharges = "ArmageddonCharges"
    HurricaneCharges = "HurricaneCharges"
    FireBlastCharges = "FireBlastCharges"
    ClawMasteryCharges = "ClawMasteryCharges"
    PsychicHammerCharges = "PsychicHammerCharges"
    TigerStrikeCharges = "TigerStrikeCharges"
    DragonTalonCharges = "DragonTalonCharges"
    ShockWebCharges = "ShockWebCharges"
    BladeSentinelCharges = "BladeSentinelCharges"
    BurstOfSpeedCharges = "BurstOfSpeedCharges"
    FistsOfFireCharges = "FistsOfFireCharges"
    DragonClawCharges = "DragonClawCharges"
    ChargedBoltSentryCharges = "ChargedBoltSentryCharges"
    WakeOfFireCharges = "WakeOfFireCharges"
    WeaponBlockCharges = "WeaponBlockCharges"
    CloakOfShadowsCharges = "CloakOfShadowsCharges"
    CobraStrikeCharges = "CobraStrikeCharges"
    BladeFuryCharges = "BladeFuryCharges"
    FadeCharges = "FadeCharges"
    ShadowWarriorCharges = "ShadowWarriorCharges"
    ClawsOfThunderCharges = "ClawsOfThunderCharges"
    DragonTailCharges = "DragonTailCharges"
    LightningSentryCharges = "LightningSentryCharges"
    WakeOfInfernoCharges = "WakeOfInfernoCharges"
    MindBlastCharges = "MindBlastCharges"
    BladesOfIceCharges = "BladesOfIceCharges"
    DragonFlightCharges = "DragonFlightCharges"
    DeathSentryCharges = "DeathSentryCharges"
    BladeShieldCharges = "BladeShieldCharges"
    VenomCharges = "VenomCharges"
    ShadowMasterCharges = "ShadowMasterCharges"
    PhoenixStrikeCharges = "PhoenixStrikeCharges"
    WakeOfDestructionSentryCharges = "WakeOfDestructionSentryCharges"
    ImpInfernoCharges = "ImpInfernoCharges"
    ImpFireballCharges = "ImpFireballCharges"
    BaalTauntCharges = "BaalTauntCharges"
    BaalCorpseExplodeCharges = "BaalCorpseExplodeCharges"
    BaalMonsterSpawnCharges = "BaalMonsterSpawnCharges"
    CatapultChargedBallCharges = "CatapultChargedBallCharges"
    CatapultSpikeBallCharges = "CatapultSpikeBallCharges"
    SuckBloodCharges = "SuckBloodCharges"
    CryHelpCharges = "CryHelpCharges"
    HealingVortexCharges = "HealingVortexCharges"
    Teleport2Charges = "Teleport2Charges"
    SelfResurrectCharges = "SelfResurrectCharges"
    VineAttackCharges = "VineAttackCharges"
    OverseerWhipCharges = "OverseerWhipCharges"
    BarbsAuraCharges = "BarbsAuraCharges"
    WolverineAuraCharges = "WolverineAuraCharges"
    OakSageAuraCharges = "OakSageAuraCharges"
    ImpFireMissileCharges = "ImpFireMissileCharges"
    ImpregnateCharges = "ImpregnateCharges"
    SiegeBeastStompCharges = "SiegeBeastStompCharges"
    MinionSpawnerCharges = "MinionSpawnerCharges"
    CatapultBlizzardCharges = "CatapultBlizzardCharges"
    CatapultPlagueCharges = "CatapultPlagueCharges"
    CatapultMeteorCharges = "CatapultMeteorCharges"
    BoltSentryCharges = "BoltSentryCharges"
    CorpseCyclerCharges = "CorpseCyclerCharges"
    DeathMaulCharges = "DeathMaulCharges"
    DefenseCurseCharges = "DefenseCurseCharges"
    BloodManaCharges = "BloodManaCharges"
    monInfernoSentryCharges = "monInfernoSentryCharges"
    monDeathSentryCharges = "monDeathSentryCharges"
    sentryLightningCharges = "sentryLightningCharges"
    fenrisRageCharges = "fenrisRageCharges"
    BaalTentacleCharges = "BaalTentacleCharges"
    BaalNovaCharges = "BaalNovaCharges"
    BaalInfernoCharges = "BaalInfernoCharges"
    BaalColdMissilesCharges = "BaalColdMissilesCharges"
    MegademonInfernoCharges = "MegademonInfernoCharges"
    EvilHutSpawnerCharges = "EvilHutSpawnerCharges"
    CountessFirewallCharges = "CountessFirewallCharges"
    ImpBoltCharges = "ImpBoltCharges"
    HorrorArcticBlastCharges = "HorrorArcticBlastCharges"
    deathSentryLtngCharges = "deathSentryLtngCharges"
    VineCyclerCharges = "VineCyclerCharges"
    BearSmiteCharges = "BearSmiteCharges"
    Resurrect2Charges = "Resurrect2Charges"
    BloodLordFrenzyCharges = "BloodLordFrenzyCharges"
    BaalTeleportCharges = "BaalTeleportCharges"
    ImpTeleportCharges = "ImpTeleportCharges"
    BaalCloneTeleportCharges = "BaalCloneTeleportCharges"
    ZakarumLightningCharges = "ZakarumLightningCharges"
    VampireMissileCharges = "VampireMissileCharges"
    MephistoMissileCharges = "MephistoMissileCharges"
    DoomKnightMissileCharges = "DoomKnightMissileCharges"
    RogueMissileCharges = "RogueMissileCharges"
    HydraMissileCharges = "HydraMissileCharges"
    NecromageMissileCharges = "NecromageMissileCharges"
    MonBowCharges = "MonBowCharges"
    MonFireArrowCharges = "MonFireArrowCharges"
    MonColdArrowCharges = "MonColdArrowCharges"
    MonExplodingArrowCharges = "MonExplodingArrowCharges"
    MonFreezingArrowCharges = "MonFreezingArrowCharges"
    MonPowerStrikeCharges = "MonPowerStrikeCharges"
    SuccubusBoltCharges = "SuccubusBoltCharges"
    MephFrostNovaCharges = "MephFrostNovaCharges"
    MonIceSpearCharges = "MonIceSpearCharges"
    ShamanIceCharges = "ShamanIceCharges"
    DiablogeddonCharges = "DiablogeddonCharges"
    DeleriumChangeCharges = "DeleriumChangeCharges"
    NihlathakCorpseExplosionCharges = "NihlathakCorpseExplosionCharges"
    SerpentChargeCharges = "SerpentChargeCharges"
    TrapNovaCharges = "TrapNovaCharges"
    UnHolyBoltExCharges = "UnHolyBoltExCharges"
    ShamanFireExCharges = "ShamanFireExCharges"
    ImpFireMissileExCharges = "ImpFireMissileExCharges"
    FixedSiegeBeastStompCharges = "FixedSiegeBeastStompCharges"
    AnyCharges = "AnyCharges"
