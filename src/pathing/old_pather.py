...
class Location:
    ...
    # TOWER
    A1_TOWER_START = "a1_tower_start"
    A1_TOWER_END = "a1_tower_end"
    # Meph
    ...
    # Pit
    A1_PIT_WP = "a1_pit_wp"
    A1_PIT_START = "a1_pit_start"
    A1_PIT_Level2 = "a1_pit_level2"
    A1_PIT_END = "a1_pit_end"
    #Stony Tomb
    ...
    def traverse_nodes(
        ...
        for i, node_idx in enumerate(path):
            ...
            while not continue_to_next_node:
                ...
                if not did_force_move and time.time() - last_move > 3.1 and not force_time_out:
                    pos_abs = (0, 150)
