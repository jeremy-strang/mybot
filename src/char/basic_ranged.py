...
#bosses
    ...
    def kill_pindle(self) -> bool:
        ...
        # Move to items
        self._old_pather.traverse_nodes((Location.A5_PINDLE_SAFE_DIST, Location.A5_PINDLE_END), self, time_out=1.4, force_tp=True)
        return True
    ...
    def kill_eldritch(self) -> bool:
        ...
        wait(self._cast_duration, self._cast_duration + 0.2)
        # Move to items
        self._old_pather.traverse_nodes((Location.A5_ELDRITCH_SAFE_DIST, Location.A5_ELDRITCH_END), self, time_out=1.4, force_tp=True)
        return True
    ...
    def kill_council(self) -> bool:
        ...
        self._old_pather.offset_node(229, [250, 130])
        self._old_pather.traverse_nodes([228, 229], self, time_out=2.5, force_tp=True)
        self._old_pather.offset_node(229, [-250, -130])
        atk_pos_abs = self._old_pather.find_abs_node_pos(230, self._screen.grab())
        ...
        atk_pos_abs = self._old_pather.find_abs_node_pos(229, self._screen.grab())
        if atk_pos_abs is None:
        ...
        cast_pos_abs = self._old_pather.find_abs_node_pos(229, self._screen.grab())
